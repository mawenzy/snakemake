...
## [8.4.1](https://github.com/mawenzy/snakemake/compare/v8.14.0...v8.4.1) (2024-06-13)


### ⚠ BREAKING CHANGES

* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/mawenzy/snakemake/issues/2403))

### Features

* add --sdm short opt for --deployment ([#2551](https://github.com/mawenzy/snakemake/issues/2551)) ([fd8b4b0](https://github.com/mawenzy/snakemake/commit/fd8b4b08da778097071ea8c32c95e21e610c6614))
* add ability to inject conda environments into running Snakefile ([#2479](https://github.com/mawenzy/snakemake/issues/2479)) ([6140e29](https://github.com/mawenzy/snakemake/commit/6140e29864cf0fcdd83194f218408867c54b730d))
* add ability to return input functions from input functions. Such nesting is evaluated 10 times at most. Beyond that, an error is thrown.  ([#2717](https://github.com/mawenzy/snakemake/issues/2717)) ([7a47924](https://github.com/mawenzy/snakemake/commit/7a47924627b30dc774efef0faae08e13e44c350a))
* add cols argument to lookup function; fix various minor bugs on cluster systems ([#2651](https://github.com/mawenzy/snakemake/issues/2651)) ([ca7a602](https://github.com/mawenzy/snakemake/commit/ca7a6022bacae77be45068adbf4386c2c93fb481))
* add flag for marking output as being updated instead of rewritten (update("test.txt")) ([#2754](https://github.com/mawenzy/snakemake/issues/2754)) ([9ba5d95](https://github.com/mawenzy/snakemake/commit/9ba5d95a657952f06ad22cc415670f79c013d3f8))
* add flag to mark files where path should not be modified ([#2888](https://github.com/mawenzy/snakemake/issues/2888)) ([d142b46](https://github.com/mawenzy/snakemake/commit/d142b46200df0e1d03b4de3ec7aafd9cdf714588))
* add function 'exists' for checking the prior existence of files or dirs before workflow execution while considering any remote storage settings. In addition: some bug fixes for error handling and the update/before_update functionality. ([ee96393](https://github.com/mawenzy/snakemake/commit/ee9639385cb2c9cec425800088faee4e4bf77c9a))
* add functionality for deploying sources if no shared FS is assumed ([#2486](https://github.com/mawenzy/snakemake/issues/2486)) ([76eac3c](https://github.com/mawenzy/snakemake/commit/76eac3c570624f818ff43f4759a27a3e284bf03c))
* add method to obtain group args for spawned jobs ([bd1b450](https://github.com/mawenzy/snakemake/commit/bd1b450950c5b6e510778ca09fe11beffd9a6ff3))
* add option to control software deployment mode (shared or non shared FS) ([#2525](https://github.com/mawenzy/snakemake/issues/2525)) ([04ec2c0](https://github.com/mawenzy/snakemake/commit/04ec2c0262b2cb96cbcd7edbbb2596979c1703ae))
* add setting for defining separate local storage prefix for remote jobs; improved ergonomics for semantic helper functions ([#2743](https://github.com/mawenzy/snakemake/issues/2743)) ([5007e5c](https://github.com/mawenzy/snakemake/commit/5007e5c038e0fa5e90a8d44ec4a75ec77c2cd91c))
* Add support for Google Service Accounts and GCE VM network configuration ([#2318](https://github.com/mawenzy/snakemake/issues/2318)) ([2b754aa](https://github.com/mawenzy/snakemake/commit/2b754aae535ef76bd2dd34bc31d5c9f5c69363de))
* add support for Kubernetes service account name spec ([#2254](https://github.com/mawenzy/snakemake/issues/2254)) ([3370426](https://github.com/mawenzy/snakemake/commit/3370426da7ee78af5de54689f623e2b5afa45f1f))
* added localrule directive ([#2180](https://github.com/mawenzy/snakemake/issues/2180)) ([9c990b0](https://github.com/mawenzy/snakemake/commit/9c990b076b51e9e2123ced56bfab176e03424770))
* allow config files to be processed with YTE ([#2269](https://github.com/mawenzy/snakemake/issues/2269)) ([8e1c22f](https://github.com/mawenzy/snakemake/commit/8e1c22ff54e85ee941c6e0ac74dd594fce80efbb))
* allow default storage provider to be explicitly set to none ([#2746](https://github.com/mawenzy/snakemake/issues/2746)) ([ce519d7](https://github.com/mawenzy/snakemake/commit/ce519d7fd2b9dde1f369cb0da27a71d910b46734))
* allow detailed configuration of shared FS usage ([#2528](https://github.com/mawenzy/snakemake/issues/2528)) ([0d34be9](https://github.com/mawenzy/snakemake/commit/0d34be90040f937021eb25becb4ef5d5aae66473))
* allow environment variables in string values of profile (e.g. paths may now contain elements like $USER). ([58dc70c](https://github.com/mawenzy/snakemake/commit/58dc70c513d08cb217647ec591df93b40517b650))
* allow for more extensive benchmark file in jsonl format ([#2691](https://github.com/mawenzy/snakemake/issues/2691)) ([de12463](https://github.com/mawenzy/snakemake/commit/de12463604bc5f24f81907e33057ff42c31c7fc2))
* allow passing of lists of functions or single functions to expand ([#2741](https://github.com/mawenzy/snakemake/issues/2741)) ([32e65df](https://github.com/mawenzy/snakemake/commit/32e65df607127a93cc1857c415154137e3fd438d))
* allow profiles to be YTE templates; adapt to eido 2.0 ([#2325](https://github.com/mawenzy/snakemake/issues/2325)) ([67d9ff2](https://github.com/mawenzy/snakemake/commit/67d9ff20ea61186d3818e7bc1d33e4414058fc1f))
* allow python expressions in --set-resources ([#2521](https://github.com/mawenzy/snakemake/issues/2521)) ([022a31e](https://github.com/mawenzy/snakemake/commit/022a31e0e75416904589c62b58e54c952d930c69))
* Allow smart_open 7.x ([#2745](https://github.com/mawenzy/snakemake/issues/2745)) ([d52c1b1](https://github.com/mawenzy/snakemake/commit/d52c1b1805d2e30124da2ac01f614fe4f5cb0257))
* Allow the environment variable SNAKEMAKE_CONDA_PREFIX to be present without --use-conda ([#2263](https://github.com/mawenzy/snakemake/issues/2263)) ([e4eba8d](https://github.com/mawenzy/snakemake/commit/e4eba8d72b84aaa460c7d1b1ac54b607e844d782))
* allow to set latency_wait in executor test suite ([c0bca0b](https://github.com/mawenzy/snakemake/commit/c0bca0bb8bf66fb34def7459f757140ce3825a25))
* automatically upload workflow sources to default storage provider if no shared FS is used ([a450c49](https://github.com/mawenzy/snakemake/commit/a450c4998de3ab7deb0fb2bc19dc59fdc484309d))
* Azbatch executor ([#1953](https://github.com/mawenzy/snakemake/issues/1953)) ([#2246](https://github.com/mawenzy/snakemake/issues/2246)) ([0f9c49f](https://github.com/mawenzy/snakemake/commit/0f9c49fe8643cca0e42e3b091cf9706a7feb877d))
* expose ResourceSettings in TestWorkflowsBase ([#2770](https://github.com/mawenzy/snakemake/issues/2770)) ([e7c323b](https://github.com/mawenzy/snakemake/commit/e7c323b707091d759592a6c0b75e8f772b2c72c5))
* Faster ci test setup  ([#2489](https://github.com/mawenzy/snakemake/issues/2489)) ([4798e8a](https://github.com/mawenzy/snakemake/commit/4798e8ac226bded585e9fe31d43ae9e93a598780))
* implement precommand ([#2482](https://github.com/mawenzy/snakemake/issues/2482)) ([ff0f979](https://github.com/mawenzy/snakemake/commit/ff0f979b68b1e12be8151c7f5547c6a13ad3ee9a))
* implement semantic helper functions for input and param function handling ([#2344](https://github.com/mawenzy/snakemake/issues/2344)) ([b4b5e51](https://github.com/mawenzy/snakemake/commit/b4b5e51ee8601b81a7ac900b2d175603c5af90a9))
* Include parameters in extended benchmarks ([#2887](https://github.com/mawenzy/snakemake/issues/2887)) ([31a9c9b](https://github.com/mawenzy/snakemake/commit/31a9c9bdb3147fe9c1f9144a584af389ec49720e))
* introduce --workflow-profile for additional workflow specific profiles that overwrite global profiles; add ability to define key-value CLI flags like --set-threads or --set-resources as multi-level dictionaries in profile config yaml files ([#2310](https://github.com/mawenzy/snakemake/issues/2310)) ([9675c17](https://github.com/mawenzy/snakemake/commit/9675c17d4d7cbb95e589767974faa9219dd4154d))
* prepare for storage plugins ([#2454](https://github.com/mawenzy/snakemake/issues/2454)) ([353a71c](https://github.com/mawenzy/snakemake/commit/353a71cba1d3dfcc48136b2d6cb744cc1252623b))
* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/mawenzy/snakemake/issues/2403)) ([2be3bfa](https://github.com/mawenzy/snakemake/commit/2be3bfa4841967928069a2a024554b8a86b699f1))
* support for continuously updated input (using Python queues) ([#2594](https://github.com/mawenzy/snakemake/issues/2594)) ([db1c0ed](https://github.com/mawenzy/snakemake/commit/db1c0edcadca499d51223d5cc72cbdfca1ff5d21))
* support for default value specification when using lookup helper function ([#2907](https://github.com/mawenzy/snakemake/issues/2907)) ([08e88e2](https://github.com/mawenzy/snakemake/commit/08e88e27f9e5ddcd5d9ebce7f79f45436262fddc))
* support for external executor plugins ([#2305](https://github.com/mawenzy/snakemake/issues/2305)) ([c9eaa4e](https://github.com/mawenzy/snakemake/commit/c9eaa4e12e4a348f93e5ea5793faaec1fd547fac))
* support for report plugins ([#2700](https://github.com/mawenzy/snakemake/issues/2700)) ([2f7d4b5](https://github.com/mawenzy/snakemake/commit/2f7d4b5196979d368f6e2eede25ca2a61220691b))
* support per rule shell exec setting via resources ([#2862](https://github.com/mawenzy/snakemake/issues/2862)) ([ab8d2dd](https://github.com/mawenzy/snakemake/commit/ab8d2ddc38b610b0bf5b2e5368cfaf349921470a))
* Tes auth ([#2169](https://github.com/mawenzy/snakemake/issues/2169)) ([3326a6f](https://github.com/mawenzy/snakemake/commit/3326a6f7bbaf9c277400625649c3da903e251e2f))
* version specific profile config files (profile/config.v8+.yaml with profile/config.yaml as fallback that matches any version) ([#2498](https://github.com/mawenzy/snakemake/issues/2498)) ([47e5811](https://github.com/mawenzy/snakemake/commit/47e581181f952884577f0237a1aa9457ee9554dd))


### Bug Fixes

* 2142 log directive in default target rule ([#2191](https://github.com/mawenzy/snakemake/issues/2191)) ([86e9624](https://github.com/mawenzy/snakemake/commit/86e962488dcd346cd0a29a2ff1b2dcd1abafb841))
* adapt linting rule to Python 3.11 ([a3a5c58](https://github.com/mawenzy/snakemake/commit/a3a5c58cbbbe9a84b7383ce046b5981271288979))
* adapt to changes in snakemake-interface-executor-plugins ([635c68a](https://github.com/mawenzy/snakemake/commit/635c68abe3c6e01a70803f2423718a99ea056a00))
* add mamba to docker image ([eb0c884](https://github.com/mawenzy/snakemake/commit/eb0c88495b506300fdf7c1afc4c02d6b91c6a582))
* add missing spaces between lines that get concatenated. ([#2268](https://github.com/mawenzy/snakemake/issues/2268)) ([7238458](https://github.com/mawenzy/snakemake/commit/7238458c6d56c5d94787b93668718358ad44e9ef))
* add storage provider args to deploy sources command ([67178e3](https://github.com/mawenzy/snakemake/commit/67178e31e68dc165c503d49eaf40340a9ad65e90))
* add testcase for script directive to work with Python 3.7 and corresponding fix. ([0b4ae2e](https://github.com/mawenzy/snakemake/commit/0b4ae2e1155378a78e0786ad4dfd5d44fa41c9ae))
* addressing [#2197](https://github.com/mawenzy/snakemake/issues/2197) by allowing 256 character account names in slurm ([#2198](https://github.com/mawenzy/snakemake/issues/2198)) ([ab58c65](https://github.com/mawenzy/snakemake/commit/ab58c652847c03a9f1529d2d7632f2788a5fadc4))
* allow lookup dpath or query to be a callable ([33f1637](https://github.com/mawenzy/snakemake/commit/33f16379a5fb7f210769b888ab34fe8a8df96daf))
* allow pepfile and pepschema to take pathlib ([#2546](https://github.com/mawenzy/snakemake/issues/2546)) ([ca91661](https://github.com/mawenzy/snakemake/commit/ca91661bf2ff215f005e8d9351fa3320d5cf5498))
* also inherit rule proxies if there is no rulename modifier specified in a use rule statement ([#2440](https://github.com/mawenzy/snakemake/issues/2440)) ([1570289](https://github.com/mawenzy/snakemake/commit/15702891b31635a79f31e857d09f3e285f71717b))
* always make sure that the original path of source cached files is properly passed into metadata persistence records ([#2179](https://github.com/mawenzy/snakemake/issues/2179)) ([8bacbd0](https://github.com/mawenzy/snakemake/commit/8bacbd0b19b0e372f5840b1fab838b79a6bab557))
* assume at most 8GB memory for default resources. This way, we avoid exploding memory requirements for large input files that are very unlikely to be put entirely into memory by any tool. ([11c2ecc](https://github.com/mawenzy/snakemake/commit/11c2eccfa72a2732d20a66bbf57995ee9dfd14ae))
* avoid premature deletion of local copies of remote storage input files used by multiple jobs ([#2874](https://github.com/mawenzy/snakemake/issues/2874)) ([21ec649](https://github.com/mawenzy/snakemake/commit/21ec649b6d69ff9eeeec229e1eb6058f417bba56))
* batch bug [#2643](https://github.com/mawenzy/snakemake/issues/2643) ([#2650](https://github.com/mawenzy/snakemake/issues/2650)) ([2ecb21b](https://github.com/mawenzy/snakemake/commit/2ecb21ba04088b9e6850447760f713784cf8b775))
* better message about profile usage upon execution ([#2391](https://github.com/mawenzy/snakemake/issues/2391)) ([cf8aea5](https://github.com/mawenzy/snakemake/commit/cf8aea5862767f104c7e03c09369d401f25d50e7))
* binary mem ([#2695](https://github.com/mawenzy/snakemake/issues/2695)) ([18689b4](https://github.com/mawenzy/snakemake/commit/18689b42dcc690deea7f27dc909379f603aaa1a9))
* bug when requesting extended benchmark with slurm ([#2855](https://github.com/mawenzy/snakemake/issues/2855)) ([0e039ff](https://github.com/mawenzy/snakemake/commit/0e039ff5d0a0880c35297a9fd5b983aa2813226b))
* bug with preemptible rules ([#2616](https://github.com/mawenzy/snakemake/issues/2616)) ([c6d7141](https://github.com/mawenzy/snakemake/commit/c6d71410a042f2c0075a75fc024bd1e05fe0af15))
* Bump yte from &gt;=1.0,&lt;2.0 to >=1.5.1,<2.0 ([#2275](https://github.com/mawenzy/snakemake/issues/2275)) ([8c0b34f](https://github.com/mawenzy/snakemake/commit/8c0b34f869e4f65ff2e47cf5f1e2863bd104f8e7))
* check template rendering output for leaked input file paths ([#2850](https://github.com/mawenzy/snakemake/issues/2850)) ([433302e](https://github.com/mawenzy/snakemake/commit/433302ee990787d1aee5ad6d7cdbcc9533646305))
* comparison to float in scheduler ([ef44d84](https://github.com/mawenzy/snakemake/commit/ef44d844b81d671604a1ce285a43ca1d5ea59d96))
* conda env inside script ([#1812](https://github.com/mawenzy/snakemake/issues/1812)) ([49cac6a](https://github.com/mawenzy/snakemake/commit/49cac6ac67fba360f2f35be7ab1972b2d8cc1f8b))
* constrain dependencies to match conda experience ([#2710](https://github.com/mawenzy/snakemake/issues/2710)) ([d9a7a13](https://github.com/mawenzy/snakemake/commit/d9a7a13d6e427c025902a78c2d21c3f21cac242b))
* correctly report lineno ([#2584](https://github.com/mawenzy/snakemake/issues/2584)) ([967a0d7](https://github.com/mawenzy/snakemake/commit/967a0d7cb90c63c7be00b49fd535cf1029f63b5b))
* deduplicate input files before retrieval from storage ([#2600](https://github.com/mawenzy/snakemake/issues/2600)) ([37cf475](https://github.com/mawenzy/snakemake/commit/37cf475a4205d306a3969ab0e3249f0c9f7d4e19))
* detect job paths that leave and then enter a group. Such paths are invalid because then the group depends on itself. ([#2527](https://github.com/mawenzy/snakemake/issues/2527)) ([5383a4d](https://github.com/mawenzy/snakemake/commit/5383a4d85f8b7a3fb61fd0b457fcd1d008c2255f))
* Detect pandas availability to select serializer ([#2300](https://github.com/mawenzy/snakemake/issues/2300)) ([e08a771](https://github.com/mawenzy/snakemake/commit/e08a771f90aef84f3075e07c8d4e4c0f7881047c))
* do not allow setting benchmark and between-workflow caching for the same rule. The reason is that when the result is taken from cache, there is no way to fill the benchmark file with any reasonable values. ([#2335](https://github.com/mawenzy/snakemake/issues/2335)) ([e2d64fa](https://github.com/mawenzy/snakemake/commit/e2d64fad76b8ca1805eeaa48c0bf8d1fb7bf4736))
* do not distinguish between local and remote rules in dryrun ([74b99ec](https://github.com/mawenzy/snakemake/commit/74b99ecee63a9922c4dbb6951cc63865955d198a))
* do not overwrite default resources setting in azure batch executor ([#2395](https://github.com/mawenzy/snakemake/issues/2395)) ([4aef3b9](https://github.com/mawenzy/snakemake/commit/4aef3b93ddf029c532fabe38e05c262dd4237b5f))
* do not pass snakefile as metadata when wms monitor flag is used ([#2573](https://github.com/mawenzy/snakemake/issues/2573)) ([13b3205](https://github.com/mawenzy/snakemake/commit/13b3205a6e808dc48fd7a3be9652b9f0c8887648))
* do not require cores to be set for non-executing modes ([#2646](https://github.com/mawenzy/snakemake/issues/2646)) ([30cf026](https://github.com/mawenzy/snakemake/commit/30cf0261004be7a4bdce5ade563271e52c97ad6a))
* do not require cores to be set for rule-level methods of the workflow API or the corresponding CLI commands (e.g. --lint). ([#2629](https://github.com/mawenzy/snakemake/issues/2629)) ([2040468](https://github.com/mawenzy/snakemake/commit/20404688e91beadd8790e3c6cdcb727bc47d597e))
* Do not scheduler execution message if no jobs are ready ([b1c4f47](https://github.com/mawenzy/snakemake/commit/b1c4f47f894e344bd48b615f397c9ab03dc05f73))
* Don't attempt to parse TBDString resources ([#2690](https://github.com/mawenzy/snakemake/issues/2690)) ([f884b50](https://github.com/mawenzy/snakemake/commit/f884b50eddf30f829b0f7d2bbda77d0148cf8cd7))
* Enable values with an = sign in default_resources ([#2340](https://github.com/mawenzy/snakemake/issues/2340)) ([c1c9229](https://github.com/mawenzy/snakemake/commit/c1c922904f09c133e39872346a541e7cd216d0d2))
* ensure lazy evaluation of resource functions/callables (this also entails, for now, a removal of the thread statistics in the yellow job stats table); further, added some clarifying sentences about resource function evaluation to the docs ([#2356](https://github.com/mawenzy/snakemake/issues/2356)) ([4c591b7](https://github.com/mawenzy/snakemake/commit/4c591b72b31d6c6c36b43f1d7773d8317352fbc9))
* ensure that auto deployment of default storage provider works in containers with read-only root home. ([1a347ff](https://github.com/mawenzy/snakemake/commit/1a347ffd8b2144aee5c35ea17fec2262c5cc9c40))
* ensure that log and benchmark files are uploaded to storage as well ([#2545](https://github.com/mawenzy/snakemake/issues/2545)) ([6aabb5d](https://github.com/mawenzy/snakemake/commit/6aabb5db16634c077ba808dbd000a3ed67d6a3c0))
* ensure that targetjob is always forced. This fixes a bug causing run-directive rules to not being executed even when enforced via e.g. -R. ([#2448](https://github.com/mawenzy/snakemake/issues/2448)) ([b2a60d5](https://github.com/mawenzy/snakemake/commit/b2a60d5674c84f58c6e48af5d675ce4690a1d625))
* error when detecting mime type during report creation ([#2721](https://github.com/mawenzy/snakemake/issues/2721)) ([42dad42](https://github.com/mawenzy/snakemake/commit/42dad4258b0b0028733b94cbde6ae63c534ba645))
* Escape workdir paths for potential spaces in paths ([#2196](https://github.com/mawenzy/snakemake/issues/2196)) ([9261f7e](https://github.com/mawenzy/snakemake/commit/9261f7ea50a8ae424c015faca73b7811fb51d093))
* expand error on modules with prefix ([#1614](https://github.com/mawenzy/snakemake/issues/1614)) ([#2803](https://github.com/mawenzy/snakemake/issues/2803)) ([c6bfcd7](https://github.com/mawenzy/snakemake/commit/c6bfcd762c595c7d009fb3c2cfff6231a1f3ffe4))
* extend workflow test suite by wildcards with slashes (in order to detect bugs that can occur in executors) ([#2810](https://github.com/mawenzy/snakemake/issues/2810)) ([fc9971b](https://github.com/mawenzy/snakemake/commit/fc9971b227e43601c8b511c1c37e4dce3211e913))
* f-string in a more robust style? ([#2649](https://github.com/mawenzy/snakemake/issues/2649)) ([2a50dc0](https://github.com/mawenzy/snakemake/commit/2a50dc02bb709161d62d6f7dc5d6f2733e534c09))
* failure message in cleanup_metadata ([#2800](https://github.com/mawenzy/snakemake/issues/2800)) ([4c7fe55](https://github.com/mawenzy/snakemake/commit/4c7fe55285fd4641d86a945110e546ad19dd9c2e))
* fix bug causing FileNotFoundError when accessing checkpoint output. ([c81954d](https://github.com/mawenzy/snakemake/commit/c81954d0bc10011a777aef7d0d5f089ee5748342))
* fix bugs in --summary and --list-input-changes. Removed outdated statement in tutorial. ([#2735](https://github.com/mawenzy/snakemake/issues/2735)) ([55c06d8](https://github.com/mawenzy/snakemake/commit/55c06d853116cf402b90832649c805643712c437))
* fix cache handling and unlock handling ([2f4d5e1](https://github.com/mawenzy/snakemake/commit/2f4d5e11b36f199d3335839e9b5dc5d2094d11f8))
* Fix collect-lookup attribute error ([#2687](https://github.com/mawenzy/snakemake/issues/2687)) ([e39c74c](https://github.com/mawenzy/snakemake/commit/e39c74c18d59f117f1e630a516ba00ee8a53c9e8))
* fix corner case bug in input function exception handling ([#2895](https://github.com/mawenzy/snakemake/issues/2895)) ([fc24292](https://github.com/mawenzy/snakemake/commit/fc24292f14fd5f8bb00412c32568645cfbf5d2fa))
* fix error message for invalid storage provider queries ([977951e](https://github.com/mawenzy/snakemake/commit/977951ea541bceb97b6a77709fde863f6c638352))
* fix error when passing callable as dpath or query of lookup function ([0e5b878](https://github.com/mawenzy/snakemake/commit/0e5b8789c763201d00e5040f439436405d04b706))
* fix exception when handling syntax error during parsing ([d5a7a56](https://github.com/mawenzy/snakemake/commit/d5a7a564beea9850d1dac9f91429d8434a3aac46))
* fix false complaints about rules with multiple output files ([#2628](https://github.com/mawenzy/snakemake/issues/2628)) ([b1b4f5b](https://github.com/mawenzy/snakemake/commit/b1b4f5b0adcd8066b7a6376e9b56778014f9921b))
* Fix inconsistencies between detailed summary and normal summary ([#2218](https://github.com/mawenzy/snakemake/issues/2218)) ([d903123](https://github.com/mawenzy/snakemake/commit/d9031236563b7dd8e31ed27208c9ad39699f765e))
* fix missed wildcard constraints when using local rule inheritance ([#2242](https://github.com/mawenzy/snakemake/issues/2242)) ([8e94785](https://github.com/mawenzy/snakemake/commit/8e947858dd510cb4c813f24093b5be843fa4cf6c))
* fix missing await when opening checkpoint output ([#2868](https://github.com/mawenzy/snakemake/issues/2868)) ([25a361b](https://github.com/mawenzy/snakemake/commit/25a361bb14fcd66a26535093e0c05b5cf84e69d8))
* fix missing storage information when handling already completed checkpoints. This solves a bug causing failure to retrieve storage files in workflows with checkpoints. ([5791c60](https://github.com/mawenzy/snakemake/commit/5791c6017195dd00a5d98c1da1e81fbfdde253b9))
* fix nargs definition for --deploy-sources ([fc252c8](https://github.com/mawenzy/snakemake/commit/fc252c80227e75a4fcf869f828d3c7d5d066f794))
* fix opening of checkpoint output files from remote storage ([#2873](https://github.com/mawenzy/snakemake/issues/2873)) ([e7cb7fb](https://github.com/mawenzy/snakemake/commit/e7cb7fb3e469057afc1f2c74008a40a716e76111))
* fix opening of multiple checkout output files in the same input function when using remote storage ([2f8e719](https://github.com/mawenzy/snakemake/commit/2f8e71927edfe636492bc14dfd7b90d3c226294c))
* fix pandas import handling in metadata persistence ([27f7b40](https://github.com/mawenzy/snakemake/commit/27f7b4014eaea66aa4e599aa854dda75822d30a0))
* fix path handling when detective profiles ([fe63881](https://github.com/mawenzy/snakemake/commit/fe63881371036fc6d55e6a113cb3ed5029b31d2d))
* fix premature deletion of temp files in combination with checkpoints ([#2737](https://github.com/mawenzy/snakemake/issues/2737)) ([b22ba5f](https://github.com/mawenzy/snakemake/commit/b22ba5f32b893e8eb50f6e3a6f0874f1c932943b))
* fix quoting issues when passing complex apptainer args to spawned jobs ([#2898](https://github.com/mawenzy/snakemake/issues/2898)) ([b07e2e0](https://github.com/mawenzy/snakemake/commit/b07e2e07aaf7b9bd6fa6368e274f08028cdcea4e))
* Fix race condition when creating lock directory ([#2225](https://github.com/mawenzy/snakemake/issues/2225)) ([66ea4d1](https://github.com/mawenzy/snakemake/commit/66ea4d199e3d9266b1b5fdb8752772e8137ffdea))
* fix scrolling behavior in landing page of report for large workflows ([63c0c31](https://github.com/mawenzy/snakemake/commit/63c0c31c222a921a843d83e330a6f91e430f209a))
* fix storage handling on windows by converting all paths to posix paths ([#2519](https://github.com/mawenzy/snakemake/issues/2519)) ([7864a76](https://github.com/mawenzy/snakemake/commit/7864a76c41ad7839fb3b9aeb1c4468215ba0cb21))
* fix string resource definition in CLI and profile ([#2627](https://github.com/mawenzy/snakemake/issues/2627)) ([bbd76ae](https://github.com/mawenzy/snakemake/commit/bbd76ae53101a28f86386d12b3bdb10a89df2251))
* fix wait for files in case of using remote storage and remote execution ([#2718](https://github.com/mawenzy/snakemake/issues/2718)) ([eec3a5f](https://github.com/mawenzy/snakemake/commit/eec3a5fd7a02c093dc14cfd0912fbaf8d7dd10cc))
* fixed bug in handling of resource overrides for remote job submission ([5c06dd6](https://github.com/mawenzy/snakemake/commit/5c06dd6a3273057144a8d5e1305c7cbdfc329b66))
* Fixed plot axis label on report ([#2683](https://github.com/mawenzy/snakemake/issues/2683)) ([a4c2a03](https://github.com/mawenzy/snakemake/commit/a4c2a03182d5f1bd5e7a9e389dc816cf7a9bc124))
* for local execution, always unrestrictedly assume shared FS ([#2679](https://github.com/mawenzy/snakemake/issues/2679)) ([0bee50b](https://github.com/mawenzy/snakemake/commit/0bee50b24538e9e17f8679fe4e7022f335e32d72))
* ga4gh executor resources ([#2042](https://github.com/mawenzy/snakemake/issues/2042)) ([ad6eaef](https://github.com/mawenzy/snakemake/commit/ad6eaef6bac05d4de682f59d9d4a088f143b5798))
* handle async method in cleanup_storage_objects ([#2806](https://github.com/mawenzy/snakemake/issues/2806)) ([272205b](https://github.com/mawenzy/snakemake/commit/272205beb0765e65c86a7b4e4f740b84ceac44b5))
* handle different f-string tokens in py3.12 ([#2485](https://github.com/mawenzy/snakemake/issues/2485)) ([f2c7613](https://github.com/mawenzy/snakemake/commit/f2c761320a5a73d6027ae3649843e6bf6a24f324))
* handle non-PEP440 versions of apptainer/singulariy ([#2337](https://github.com/mawenzy/snakemake/issues/2337)) ([dea6ba8](https://github.com/mawenzy/snakemake/commit/dea6ba8808793b88c7553880bde48711abb037f8))
* handle storage for local jobs; add test case ([6d978ef](https://github.com/mawenzy/snakemake/commit/6d978ef31060393bd3a69b7973170e3c79473705))
* handling of group jobs when obtaining temp input files ([71be1de](https://github.com/mawenzy/snakemake/commit/71be1de734032ae8c9e8b07fad57e36b321be421))
* if report files are within storage, retrieve them from storage before loading into report ([60041bd](https://github.com/mawenzy/snakemake/commit/60041bdbc3c6e941585f1876f3e5d598bfaa9caf))
* ignore errors when cleaning up runtime cache ([#2859](https://github.com/mawenzy/snakemake/issues/2859)) ([6df7046](https://github.com/mawenzy/snakemake/commit/6df70468bb29a9a5b172caa5fe5a1a8bde3f2ebe))
* import ([#2402](https://github.com/mawenzy/snakemake/issues/2402)) ([2c831f1](https://github.com/mawenzy/snakemake/commit/2c831f1fa98813cf5f69ecb046aad1364f514238))
* improved error handling for storage upload; fixed bugs caused by outdated calls to IOFile.exists(). ([720bb84](https://github.com/mawenzy/snakemake/commit/720bb8400ecf8e6c3caf3ca6b47d7dda4f1f7ba9))
* improved error messages in case of invalid storage queries ([9671fd0](https://github.com/mawenzy/snakemake/commit/9671fd0770fbe2d79d3546ca5f19c8fc39ffc25a))
* in addition to localrules statement,  infer that job is local if it has any input or output file that is marked as local ([#2541](https://github.com/mawenzy/snakemake/issues/2541)) ([e8b682b](https://github.com/mawenzy/snakemake/commit/e8b682be0bd52a01ec3ebdbbcb1ec018950819b2))
* invalid extensions with multixt and cache ([#1808](https://github.com/mawenzy/snakemake/issues/1808)) ([#2823](https://github.com/mawenzy/snakemake/issues/2823)) ([a845b1c](https://github.com/mawenzy/snakemake/commit/a845b1c62b106fb4c0f1b97485a3044bfbcab65b))
* less frightering message when telling about missing output files as reason for running a job ([7b6c9d4](https://github.com/mawenzy/snakemake/commit/7b6c9d4f620e020911192e0f311f1d9098391e0d))
* local mtime handling in case of storage plugins and cleaner error message for parallel storage retrieval ([#2611](https://github.com/mawenzy/snakemake/issues/2611)) ([880b264](https://github.com/mawenzy/snakemake/commit/880b2645c961a98c0eb33b9cdab75d7804860c0a))
* make checkpoint updates synchronous ([#2871](https://github.com/mawenzy/snakemake/issues/2871)) ([b0e7ebd](https://github.com/mawenzy/snakemake/commit/b0e7ebde7d95ac13b517ee4f200c92ebb1b1b805))
* Migrate away from deprecated pulp API ([#2610](https://github.com/mawenzy/snakemake/issues/2610)) ([fb26640](https://github.com/mawenzy/snakemake/commit/fb2664008d6cffd09c52ec9fd9c994bd198ed69c))
* migration guide typo and wrong link ([#2625](https://github.com/mawenzy/snakemake/issues/2625)) ([645f3d1](https://github.com/mawenzy/snakemake/commit/645f3d1426c1dcd41adf813bdb833060775ffda5))
* module prefix added twice on expand ([#2814](https://github.com/mawenzy/snakemake/issues/2814)) ([27416f4](https://github.com/mawenzy/snakemake/commit/27416f4e233662162232de33e9b82205f7efe397))
* move apptainer into separate env in docker image ([94e9e2c](https://github.com/mawenzy/snakemake/commit/94e9e2c33ee63551aa3630c7106344ee2fa11f4d))
* omit norun jobs when determining remote storage input file retrieval ([#2854](https://github.com/mawenzy/snakemake/issues/2854)) ([37a7c7f](https://github.com/mawenzy/snakemake/commit/37a7c7f9dbd7295e558298097301827f714db994))
* only consider global wildcard_constraints from the same module ([#2235](https://github.com/mawenzy/snakemake/issues/2235)) ([c412b71](https://github.com/mawenzy/snakemake/commit/c412b714a9fbe5cad9ad30de4a0b78b3c13068f6))
* only constrain by --max-threads if threads of job are already known ([#2790](https://github.com/mawenzy/snakemake/issues/2790)) ([5f28fcd](https://github.com/mawenzy/snakemake/commit/5f28fcd32bd8fa0f539c4fc8aabf07702787132b))
* only deactivate conda inject envs upon workflow tear down ([#2503](https://github.com/mawenzy/snakemake/issues/2503)) ([e6dfdd4](https://github.com/mawenzy/snakemake/commit/e6dfdd49cbaad228827f62a48cfe6419e4c1715e))
* only download input for local jobs in the main process, not within remote groups ([#2842](https://github.com/mawenzy/snakemake/issues/2842)) ([97f428b](https://github.com/mawenzy/snakemake/commit/97f428ba2921cebc2a311a4933c1c55536d34335))
* output of rulegraph, closes [#2656](https://github.com/mawenzy/snakemake/issues/2656) ([#2671](https://github.com/mawenzy/snakemake/issues/2671)) ([f9b9110](https://github.com/mawenzy/snakemake/commit/f9b9110b2b0e25db25f76ceeabcf548b70aff839))
* Panoptes --wms-monitor-arg ([#2444](https://github.com/mawenzy/snakemake/issues/2444)) ([98d2bdf](https://github.com/mawenzy/snakemake/commit/98d2bdfd1e3aeddf189b272d3e4042632248c10f))
* passing of --set-threads values to remote jobs ([#2775](https://github.com/mawenzy/snakemake/issues/2775)) ([4fd767a](https://github.com/mawenzy/snakemake/commit/4fd767a4e57043551e0551542a93dbc9d34df777))
* Prevent binary log files to crash snakemake execution with `show-failed-logs` ([#2827](https://github.com/mawenzy/snakemake/issues/2827)) ([8a80bda](https://github.com/mawenzy/snakemake/commit/8a80bdaed0d8524dffbdce71dd07eb123f71726d))
* print exceptions when job is not a shell job ([#2385](https://github.com/mawenzy/snakemake/issues/2385)) ([8a37b85](https://github.com/mawenzy/snakemake/commit/8a37b8584f216ada10caffcbb8b731efd675376a))
* proper interpretation of standard resources given as strings (e.g. runtime as '5m'). Avoid the need to set additional quotes around size or timespan resources. Improved error messages for resource handling.  ([#2716](https://github.com/mawenzy/snakemake/issues/2716)) ([b6636e9](https://github.com/mawenzy/snakemake/commit/b6636e95f6d9baddb4a3eb5bc79351207f048b4d))
* proper reuse of rule proxies when importing several times from the same module ([#2404](https://github.com/mawenzy/snakemake/issues/2404)) ([e867dda](https://github.com/mawenzy/snakemake/commit/e867dda24dff306f42939ad0d4d93d32ec94f6e5))
* properly delete local copies of storage files after remote jobs ([#2793](https://github.com/mawenzy/snakemake/issues/2793)) ([e3362b0](https://github.com/mawenzy/snakemake/commit/e3362b03e11d9770ed6b01e82017973f4a652d4a))
* properly handle --touch when using a storage provider ([#2705](https://github.com/mawenzy/snakemake/issues/2705)) ([fca138d](https://github.com/mawenzy/snakemake/commit/fca138d680ac0abad14df8dc208a84f1ae0dc0e2))
* properly resolve wildcards in group components ([#2620](https://github.com/mawenzy/snakemake/issues/2620)) ([c788a46](https://github.com/mawenzy/snakemake/commit/c788a465f25dc700103df6475d566d81e2c88bef))
* properly restrict scheduler if --jobs/-j is used (in contrast to --cores) in local execution ([#2897](https://github.com/mawenzy/snakemake/issues/2897)) ([6a276bb](https://github.com/mawenzy/snakemake/commit/6a276bb25cc36d32285a196e0876e2b15040a863))
* quote paths given to singularity in order to ensure that it does not fail when paths contain whitespace ([#2190](https://github.com/mawenzy/snakemake/issues/2190)) ([a572fb7](https://github.com/mawenzy/snakemake/commit/a572fb7b8f00e39723cd98d6936f63171b26c8d9))
* remote GS builds too many inventories; io:collect_mtime always uses uncached mtime ([#2266](https://github.com/mawenzy/snakemake/issues/2266)) ([bad9115](https://github.com/mawenzy/snakemake/commit/bad91152eeb70693e1459324f738a8c481378801))
* remote-azblob-sasToken-Authorization ([#1800](https://github.com/mawenzy/snakemake/issues/1800)) ([bc854a7](https://github.com/mawenzy/snakemake/commit/bc854a7e012cac751b708df83378fd5791e6e6fc))
* remove bash completion entrypoint (no longer supported, was too slow to be usable anyway) ([922b53a](https://github.com/mawenzy/snakemake/commit/922b53aa0cba05da067cc67fccc6852bbc161edb))
* remove default packages from conda envs ([#2749](https://github.com/mawenzy/snakemake/issues/2749)) ([027906c](https://github.com/mawenzy/snakemake/commit/027906c519b5e39a628dda072f314e7b9f6343dc))
* remove non-empty local copies of remote storage dirs ([#2845](https://github.com/mawenzy/snakemake/issues/2845)) ([71b2b87](https://github.com/mawenzy/snakemake/commit/71b2b87644ac0470aba1a96093e88e9a64df1176))
* remove superfluous dependency ([aad61a0](https://github.com/mawenzy/snakemake/commit/aad61a0131d7ca0f7393af23b98b1db702cd976d))
* removed distutils from snakemake ([#2312](https://github.com/mawenzy/snakemake/issues/2312)) ([9b8c362](https://github.com/mawenzy/snakemake/commit/9b8c3620e8c14e322ba15b7d044b9deab1854b2a))
* replace pkg_resources for python 3.12 ([#2831](https://github.com/mawenzy/snakemake/issues/2831)) ([ac144fc](https://github.com/mawenzy/snakemake/commit/ac144fc7c68083cc56d1960f46b5f5e7888dd38e))
* report spacing ([f3954b3](https://github.com/mawenzy/snakemake/commit/f3954b33536314e6a252c044eee5f424dd234065))
* require python &gt;=3.7 again (the python 3.9 dependency was unnecessary) ([#2372](https://github.com/mawenzy/snakemake/issues/2372)) ([0d0e9c4](https://github.com/mawenzy/snakemake/commit/0d0e9c4cf48a97952464e6da476ed7661d629ce3))
* respect APPTAINER_CACHEDIR and allow env variables in --apptainer-prefix and --conda-prefix ([#2795](https://github.com/mawenzy/snakemake/issues/2795)) ([b1694cd](https://github.com/mawenzy/snakemake/commit/b1694cdf10ce46ff80236a8bb1d9c72e2f0fae0e))
* Restore backward compatibility for Google Life Sciences executor ([#2461](https://github.com/mawenzy/snakemake/issues/2461)) ([5e3a464](https://github.com/mawenzy/snakemake/commit/5e3a46476d78d5d52340a9ffa327d18a5e7e9828))
* retrieve files from storage if necessary when calling their open method (e.g. when accessing output files from a checkpoint) ([#2839](https://github.com/mawenzy/snakemake/issues/2839)) ([5448208](https://github.com/mawenzy/snakemake/commit/54482089893d12a0cab20a7b4b3d0af5a87aa772))
* retrieve inputs of local rules from storage even if they are intermediate results ([#2811](https://github.com/mawenzy/snakemake/issues/2811)) ([d158aa8](https://github.com/mawenzy/snakemake/commit/d158aa849fb16fb3931d05fb052684c5d09862cd))
* return set instead of list when just --quiet ([#2829](https://github.com/mawenzy/snakemake/issues/2829)) ([eeb57e2](https://github.com/mawenzy/snakemake/commit/eeb57e26c4d85b520d5ae69a0f00183d4ea80eb8))
* return set of rules when obtaining allowed rules for remote job ([2c44cf6](https://github.com/mawenzy/snakemake/commit/2c44cf641335812ca0877e3987726403c8919415))
* set ignore_incomplete to False in create_conda_envs  ([#2653](https://github.com/mawenzy/snakemake/issues/2653)) ([4834a42](https://github.com/mawenzy/snakemake/commit/4834a42180fb513670b310fcbaadd07a34adf0b7))
* Setting the value of ignore_incomplete Fixes [#2556](https://github.com/mawenzy/snakemake/issues/2556) ([#2654](https://github.com/mawenzy/snakemake/issues/2654)) ([05dac64](https://github.com/mawenzy/snakemake/commit/05dac64666cca196e232beed4b6f1167dfbfc3bd))
* shadow "full" mode ignore symlinks ([#2516](https://github.com/mawenzy/snakemake/issues/2516)) ([1d58120](https://github.com/mawenzy/snakemake/commit/1d5812027e5d1a8d5f2e45175fa38d28ca32763e))
* show failed logs in executor testcases ([92f7bf4](https://github.com/mawenzy/snakemake/commit/92f7bf4b86f491073898b2385c3ed45a557a3b4d))
* show queries of remote storage files instead of local paths in summary ([#2860](https://github.com/mawenzy/snakemake/issues/2860)) ([ba1db8e](https://github.com/mawenzy/snakemake/commit/ba1db8eaf34a37a4d6029dd1bcddea49a775b912))
* single line f-string format error in py3.12 ([#2588](https://github.com/mawenzy/snakemake/issues/2588)) ([87c06c0](https://github.com/mawenzy/snakemake/commit/87c06c0f5745f577c12db39852c6f763a2d41954))
* Slack log service ([#2537](https://github.com/mawenzy/snakemake/issues/2537)) ([26eb4ba](https://github.com/mawenzy/snakemake/commit/26eb4babc28464a24c33d75703e7bf4f15c0e33f))
* slurm batch job status queries ([#2167](https://github.com/mawenzy/snakemake/issues/2167)) ([0bb69e4](https://github.com/mawenzy/snakemake/commit/0bb69e429e161bf68b1f3e0b8f6fe3cbd6ed4dae))
* small typo in error ([#2853](https://github.com/mawenzy/snakemake/issues/2853)) ([325a715](https://github.com/mawenzy/snakemake/commit/325a715b11f1763d835c67f70e2d301e903c7ebb))
* Solve apptainer version issue ([#2333](https://github.com/mawenzy/snakemake/issues/2333)) ([a876e0f](https://github.com/mawenzy/snakemake/commit/a876e0f5e187168eb269b504918c6aeff1496f16))
* sort report (sub-)categories in lexicographical order ([#2449](https://github.com/mawenzy/snakemake/issues/2449)) ([d0705ad](https://github.com/mawenzy/snakemake/commit/d0705adb4702ead9db0c26809859c7b769d800e1))
* support list of queries for storage provider ([#2674](https://github.com/mawenzy/snakemake/issues/2674)) ([d53ef92](https://github.com/mawenzy/snakemake/commit/d53ef92e79f5e8cf0187a1aa25c321c1478914d8))
* SyntaxWarning due to invalid escape sequences in non-raw regex pattern string ([#2670](https://github.com/mawenzy/snakemake/issues/2670)) ([3748d9d](https://github.com/mawenzy/snakemake/commit/3748d9dc937195a54bc052994f6d2fa05373da42))
* SyntaxWarnings due to non-raw regex pattern strings ([#2359](https://github.com/mawenzy/snakemake/issues/2359)) ([a08c0b0](https://github.com/mawenzy/snakemake/commit/a08c0b071b2f9a9212117bbcf560fa67f1a02178))
* typo in workflow specific profile default location ([#2878](https://github.com/mawenzy/snakemake/issues/2878)) ([74627d3](https://github.com/mawenzy/snakemake/commit/74627d3f07f549600dc8ad226a545f44191141e0))
* unnecessary set Snakefile in AzBatch executor ([#2397](https://github.com/mawenzy/snakemake/issues/2397)) ([78e6d6e](https://github.com/mawenzy/snakemake/commit/78e6d6ec6a1ad930e40d6edfe9f7210232a674f2))
* Update __init__.py to move "file" param to "print" ([#2291](https://github.com/mawenzy/snakemake/issues/2291)) ([92352b6](https://github.com/mawenzy/snakemake/commit/92352b69d14ef196b0253561c78fa04ffa25d73e))
* update minimum snakemake-interface-storage-plugins version ([0ef7226](https://github.com/mawenzy/snakemake/commit/0ef72262e29a5b22cdf016a4ab6aba4b8dbc686d))
* updating of non-dict config values gives error ([#2364](https://github.com/mawenzy/snakemake/issues/2364)) ([b33aeec](https://github.com/mawenzy/snakemake/commit/b33aeecdf51afba6012007a2b125b9c87b7b98f2))
* Use `job.rule.name` attribute to fill rule field in summary ([#2217](https://github.com/mawenzy/snakemake/issues/2217)) ([837c3fd](https://github.com/mawenzy/snakemake/commit/837c3fd97b5a16ddb4f6b74bd2c2b5479d77bd8a))
* use base64 encoding for passing default resources args to jobs ([#2780](https://github.com/mawenzy/snakemake/issues/2780)) ([4735bc3](https://github.com/mawenzy/snakemake/commit/4735bc3b81d9db96da0fb949893285ec0f77d076))
* use base64 encoding when passing resources and threads to remote jobs (this solves issues with complex quoted resources) ([#2778](https://github.com/mawenzy/snakemake/issues/2778)) ([a8ee4d8](https://github.com/mawenzy/snakemake/commit/a8ee4d8a8228aeac7bccefdc3b868059455e38c4))
* use default container image if nothing is provided ([#2677](https://github.com/mawenzy/snakemake/issues/2677)) ([109c991](https://github.com/mawenzy/snakemake/commit/109c991cea1ca757086488b3ca07f59cb843b46f))
* use default group settings if not execution workflow (fixes attribute error occurring with --report) ([#2617](https://github.com/mawenzy/snakemake/issues/2617)) ([21e9964](https://github.com/mawenzy/snakemake/commit/21e996421abd72122a1403a10eb74c111bde28be))
* use keyword arguments in `_IOFile.open` ([#2847](https://github.com/mawenzy/snakemake/issues/2847)) ([50c84dc](https://github.com/mawenzy/snakemake/commit/50c84dc8a3b39143ea53edb77081448762832678))
* use temporary directory (faster, more likely local, always writable) for persistence and source cache in case of remote execution without shared fs ([#2502](https://github.com/mawenzy/snakemake/issues/2502)) ([c8fa7ba](https://github.com/mawenzy/snakemake/commit/c8fa7ba3ee70c9c62011a3839758a5eb8fde16f8))
* various bug fixes for resource parsing ([#2711](https://github.com/mawenzy/snakemake/issues/2711)) ([d1daf0b](https://github.com/mawenzy/snakemake/commit/d1daf0b4b2cc64b92adb9f58ac71c601ab5d29c8))
* various error handling improvements, fixed logging/error behavior (stdout from dryrun, stderr otherwise) ([#2759](https://github.com/mawenzy/snakemake/issues/2759)) ([d0d1f48](https://github.com/mawenzy/snakemake/commit/d0d1f48e9bc1f8f994c2f243255b84a1b73e5208))
* wait for logs before showing them on error ([a4ff328](https://github.com/mawenzy/snakemake/commit/a4ff3280db0beb4f1a077ee880433f767c4ad142))
* when using remote storage: only wait for files if job did not error ([8c7ee91](https://github.com/mawenzy/snakemake/commit/8c7ee91ac5425279955e60071fd0269bf2bf197b))
* wms-monitor now gets data in correct json format ([#2347](https://github.com/mawenzy/snakemake/issues/2347)) ([7fafa7a](https://github.com/mawenzy/snakemake/commit/7fafa7ace72f8a727457f4abe6db2f9ed2d74d64))
* wrong rule names when nesting module imports ([#1817](https://github.com/mawenzy/snakemake/issues/1817)) ([65c79a4](https://github.com/mawenzy/snakemake/commit/65c79a48f956077839bb5ab1ea8d60a5f0ddecab))


### Performance Improvements

* avoid superflous mtime checks when the same file is referred to by multiple jobs ([#2284](https://github.com/mawenzy/snakemake/issues/2284)) ([eb6e2e1](https://github.com/mawenzy/snakemake/commit/eb6e2e161f01c61b139d95bcf1ddfa862f8029ba))


### Documentation

* add badge for bioconda version ([#2902](https://github.com/mawenzy/snakemake/issues/2902)) ([3f01348](https://github.com/mawenzy/snakemake/commit/3f01348cda9040adc7af6c8173f9108343edde10))
* add link to code of conduct ([889a3bc](https://github.com/mawenzy/snakemake/commit/889a3bca881e913764e4a4dc0eea70ee7ace8598))
* add missing doc dependency ([7ba9c21](https://github.com/mawenzy/snakemake/commit/7ba9c21ac949ae6952044944af68874c516791ff))
* add Morten Lund as another maintainer. ([293bc05](https://github.com/mawenzy/snakemake/commit/293bc056b6c44f17340543b2678f8a59e808a5a6))
* add note on google executor backends ([ff8683c](https://github.com/mawenzy/snakemake/commit/ff8683c80511a78103c14442a3d3fb81bcbef2cc))
* add snakemake and reportplugins to req.txt to show all cli options ([#2817](https://github.com/mawenzy/snakemake/issues/2817)) ([aaa9065](https://github.com/mawenzy/snakemake/commit/aaa906565d102774b99b1515be0747d59e1828a6))
* added changelog info for &gt;v7.19.1 parsing error of "hh:mm:ss" time format in runtime resource ([#2189](https://github.com/mawenzy/snakemake/issues/2189)) ([2889f38](https://github.com/mawenzy/snakemake/commit/2889f3851b64cee7885fbf73f64a453eed5e806a))
* added Mastodon follow label with just 'Follow' similar to X ([#2692](https://github.com/mawenzy/snakemake/issues/2692)) ([7e36496](https://github.com/mawenzy/snakemake/commit/7e364968fb601b2fd87dc5cd703e251b708a0e19))
* api docs polishing ([58a6a13](https://github.com/mawenzy/snakemake/commit/58a6a139a6fe2719de7d2d7c98e21f4d33a67cba))
* basics.rst: suggest VS Code instead of deprecated Atom as IDE ([#2368](https://github.com/mawenzy/snakemake/issues/2368)) ([1357316](https://github.com/mawenzy/snakemake/commit/135731605b974915cd2bd78b88a981f974bc7b78))
* Change snakemake-tutorial download link to always be the latest ([#2183](https://github.com/mawenzy/snakemake/issues/2183)) ([ae8a8f4](https://github.com/mawenzy/snakemake/commit/ae8a8f4abca233e0c162e3fbd9dfb29ef38f98e6))
* clarify minimum Snakemake version for profiles ([86dc277](https://github.com/mawenzy/snakemake/commit/86dc277d530a557c9bdd6784b863f63ab859a1c7))
* clarify the channel priority in environment definition deployment.rst ([#2352](https://github.com/mawenzy/snakemake/issues/2352)) ([76aa964](https://github.com/mawenzy/snakemake/commit/76aa964c38b4aa069d9cce6f8f43c91c7d496cfb))
* diff 7 and 8 ([#2561](https://github.com/mawenzy/snakemake/issues/2561)) ([ba22e07](https://github.com/mawenzy/snakemake/commit/ba22e07af2ab8248888cb57f4bcb8a9eb2623977))
* document name directive with example ([#2534](https://github.com/mawenzy/snakemake/issues/2534)) ([cce5551](https://github.com/mawenzy/snakemake/commit/cce555142814f5bd1d73e68b9a17b772454817d4))
* fix [#2698](https://github.com/mawenzy/snakemake/issues/2698) ([#2714](https://github.com/mawenzy/snakemake/issues/2714)) ([508080b](https://github.com/mawenzy/snakemake/commit/508080b8e1185c45e4c3d7b413350c68444db90c))
* fix a copy&paste (?) mistake ([#2386](https://github.com/mawenzy/snakemake/issues/2386)) ([d878847](https://github.com/mawenzy/snakemake/commit/d87884749fd9450062f6fde5b7727867396e7a78))
* fix apidocs theme ([1fb5467](https://github.com/mawenzy/snakemake/commit/1fb546772bc90d96af2a390ced2d02db100ad810))
* fix cli options rendering ([264c1a9](https://github.com/mawenzy/snakemake/commit/264c1a92e824323b3060192d7a22aeb0c07678e0))
* fix explanation on how to use all cores in tutorial ([#2733](https://github.com/mawenzy/snakemake/issues/2733)) ([6420428](https://github.com/mawenzy/snakemake/commit/64204286f3061c494389ea502f1e4393e357efcd))
* fix formatting ([087fe63](https://github.com/mawenzy/snakemake/commit/087fe6307a72a577daefcea0cb150f69092138c7))
* fix heading ([1eda36d](https://github.com/mawenzy/snakemake/commit/1eda36d9d7e545b05428548f8b826e941ad078d9))
* fix headings ([d947f85](https://github.com/mawenzy/snakemake/commit/d947f85172f777ade0dc97bbe853c456517f28f6))
* fix links ([420ea9c](https://github.com/mawenzy/snakemake/commit/420ea9ca52d3de76f93e3ad30d922a97950c75de))
* fix statement about logging ([#2252](https://github.com/mawenzy/snakemake/issues/2252)) ([56c24b6](https://github.com/mawenzy/snakemake/commit/56c24b6436cee9a4962d006bb201708c7a37c474))
* fix syntax highlighting in tutorial ([2887604](https://github.com/mawenzy/snakemake/commit/2887604ebe8a1e4c9c226780129312f556150dca))
* fix syntax in cluster example ([#2460](https://github.com/mawenzy/snakemake/issues/2460)) ([64e9645](https://github.com/mawenzy/snakemake/commit/64e964554748bdee93bad1c7e6cd2924595c414f))
* fix typo (stackoverflow issue) ([#2365](https://github.com/mawenzy/snakemake/issues/2365)) ([f770984](https://github.com/mawenzy/snakemake/commit/f7709844cd932465859a2095edafcf9baa8c2bf7))
* fix typo and link for RO Crate ([#2851](https://github.com/mawenzy/snakemake/issues/2851)) ([cec0041](https://github.com/mawenzy/snakemake/commit/cec0041a71cbd4ebb4e1f8ec4ca296127a65b24b))
* fix typo in `rules.py` ([#2636](https://github.com/mawenzy/snakemake/issues/2636)) ([8bc2919](https://github.com/mawenzy/snakemake/commit/8bc291933201e205717f3346b743153b57764a6a))
* fix typos in --help ([#2182](https://github.com/mawenzy/snakemake/issues/2182)) ([09f0cbe](https://github.com/mawenzy/snakemake/commit/09f0cbe9452a22bde768c7049eeb17f1c93db7ea))
* fixes in migration guide ([f8adefa](https://github.com/mawenzy/snakemake/commit/f8adefaa605bd87df40440a211276a6825d138ed))
* handle overflow of content div ([b23e277](https://github.com/mawenzy/snakemake/commit/b23e2776ce810d64225e7675039a33ac0e920bb9))
* improve branch function docs ([e9d1a11](https://github.com/mawenzy/snakemake/commit/e9d1a11ca67456d7304b580ae6e1f1ae01e712cd))
* Improve error message when rule contains multiple run/shell/script/notebook/wrapper/template_engine/cwl keywords ([#2186](https://github.com/mawenzy/snakemake/issues/2186)) ([cd5a3c4](https://github.com/mawenzy/snakemake/commit/cd5a3c44eace393f24d9338b21d5ef3cb6298126))
* mention maintainers ([be95e25](https://github.com/mawenzy/snakemake/commit/be95e25d7ee65abe993f08b9d6ca726ee79ec7d4))
* note on using checkpoint mechanism only for input function, not for params or resources. ([#2353](https://github.com/mawenzy/snakemake/issues/2353)) ([4be2f9d](https://github.com/mawenzy/snakemake/commit/4be2f9dd9fb41dc169bae068753ceed9552248e7))
* notes on arm based machines in tutorial docs ([0586f04](https://github.com/mawenzy/snakemake/commit/0586f04d2b03443a25deddd017f303156acdcd9c))
* replace `nosetest` with `pytest` ([#2211](https://github.com/mawenzy/snakemake/issues/2211)) ([f6b3c47](https://github.com/mawenzy/snakemake/commit/f6b3c47983bfe436f8ec33ab5830ba577fc38f90))
* **rust:** Fix typo on rust-script version ([#2488](https://github.com/mawenzy/snakemake/issues/2488)) ([a79dd94](https://github.com/mawenzy/snakemake/commit/a79dd94f330f1d5c1fba7d16cb5b08bd780d950d))
* update CHANGELOG.md: add minimum Python version bump ([#2370](https://github.com/mawenzy/snakemake/issues/2370)) ([48e934d](https://github.com/mawenzy/snakemake/commit/48e934dcf96e4e8fd30c81cab3674583bf049a45))
* update code of conduct email address ([3047683](https://github.com/mawenzy/snakemake/commit/3047683bed9e28f9e5abc0d56f981aff18fbc801))
* update docs for azbatch and dockerhub ref ([#2298](https://github.com/mawenzy/snakemake/issues/2298)) ([908dbf1](https://github.com/mawenzy/snakemake/commit/908dbf143d4b1625fa6ee80f2b4eb713a6411a3f))
* update FAQ - recommend ensure function for failing on empty output ([#2910](https://github.com/mawenzy/snakemake/issues/2910)) ([b035071](https://github.com/mawenzy/snakemake/commit/b03507119806f1ada71f950086256c4fe63eb754))
* update misc/vim/Readme with info for packer.nvim ([#2095](https://github.com/mawenzy/snakemake/issues/2095)) ([32166a7](https://github.com/mawenzy/snakemake/commit/32166a7fce95312bfa6b6d3ae76bf94accf6d5de))
* Update workflow syntax with priority directive ([#2188](https://github.com/mawenzy/snakemake/issues/2188)) ([af10db5](https://github.com/mawenzy/snakemake/commit/af10db56b11badfab2aa4f3aa9fa4bbe3c05fe7d))
* use sphinxawesome-theme instead of lutra ([4401e9c](https://github.com/mawenzy/snakemake/commit/4401e9c2c53adb46609930b872b5da27b5af58fe))


### Miscellaneous Chores

* release 8.4.1 ([f8b3bd7](https://github.com/mawenzy/snakemake/commit/f8b3bd785e0751e7153346d9fed563f5e4acf6d8))
